...
void QEngine::copyBufferToImage(VkBuffer buffer, VkImage image, uint32_t width, uint32_t height) {
...
void QEngine::updateVertexIndexBuffers(){
...
void QEngine::createVertexBuffer() {
...
void QEngine::createStagingBuffer(){
...
void QEngine::createIndexBuffer() {
