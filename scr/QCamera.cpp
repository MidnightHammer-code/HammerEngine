...
void QEngine::cameraMode(int mode){
    cameraModeInit = mode;
}

void QEngine::updateCameraDefault3D(){
    glfwPollEvents();
...
void QEngine::updateCameraDefaultGravety3D(bool fall){
    glfwPollEvents();
...
void QEngine::updateCameraDefault2D(){
    glfwPollEvents();
